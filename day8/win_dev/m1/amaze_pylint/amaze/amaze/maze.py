...
class Maze(object):
    ...
    def connected(self, point1_x, point1_y, point2_x, point2_y):
    ...
    def width(self):
        """
        Provide width of the maze
        :return: Width
        """
        return self._width

    def out_of_bounds(self, point_x, point_y):
        ...
        False
        """
        return point_x < 0 or point_y < 0 or point_x >= self._width or point_y >= self._height
